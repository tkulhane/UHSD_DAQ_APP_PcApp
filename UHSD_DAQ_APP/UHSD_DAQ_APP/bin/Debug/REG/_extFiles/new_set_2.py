...
# pll1_cfg2_rprior2[3:2] = 0x0
# pll1_cfg2_rprior3[5:4] = 0x1
# pll1_cfg2_rprior4[7:6] = 0x2
dut.write(0x14, 0x93)
...
# pll1_cfg8_los_div_setpt_vcxo[7:0] = 0x1
dut.write(0x20, 0x1)

# pll1_cfg16_refdivrat_lsb[7:0] = 0x8
dut.write(0x21, 0x8)

# pll1_cfg16_refdivrat_msb[7:0] = 0x0
dut.write(0x22, 0x0)

# pll1_cfg16_fbdivrat_lsb[7:0] = 0x8
dut.write(0x26, 0x8)
...
# pll2_rdiv_cfg12_divratio_lsb[7:0] = 0xA
dut.write(0x33, 0xA)

# pll2_rdiv_cfg12_divratio_msb[3:0] = 0x0
dut.write(0x34, 0x0)

# pll2_vdiv_cfg16_divratio_lsb[7:0] = 0xE1
dut.write(0x35, 0xE1)
...
# glbl_cfg5_gpi3_en[0:0] = 0x1
# glbl_cfg5_gpi3_sel[4:1] = 0x4
dut.write(0x48, 0x9)

# glbl_cfg5_gpi4_en[0:0] = 0x0
# glbl_cfg5_gpi4_sel[4:1] = 0x0
dut.write(0x49, 0x0)
...
# sysr_cfg16_divrat_lsb[7:0] = 0xE8
dut.write(0x5C, 0xE8)

# sysr_cfg16_divrat_msb[3:0] = 0x3
dut.write(0x5D, 0x3)
...
# alrm_ro1_plls_both_locked_now[3:3] = 0x1
...
# clkgrp1_div1_cfg12_divrat_lsb[7:0] = 0x48
dut.write(0xC9, 0x48)
...
# clkgrp1_div2_cfg12_divrat_lsb[7:0] = 0x20
dut.write(0xD3, 0x20)
...
# clkgrp1_div2_cfg2_mutesel[7:6] = 0x2
dut.write(0xDA, 0x91)
...
# clkgrp2_div1_cfg12_divrat_lsb[7:0] = 0x48
dut.write(0xDD, 0x48)
...
# clkgrp2_div1_cfg5_sel_coarse_delay[4:0] = 0x3
dut.write(0xE0, 0x3)
...
# clkgrp2_div2_cfg12_divrat_lsb[7:0] = 0x20
dut.write(0xE7, 0x20)
...
# clkgrp2_div2_cfg5_sel_coarse_delay[4:0] = 0x3
dut.write(0xEA, 0x3)
...
# clkgrp2_div2_cfg2_mutesel[7:6] = 0x2
dut.write(0xEE, 0x91)
...
# clkgrp3_div1_cfg12_divrat_lsb[7:0] = 0x48
dut.write(0xF1, 0x48)

# clkgrp3_div1_cfg12_divrat_msb[3:0] = 0x0
dut.write(0xF2, 0x0)

# clkgrp3_div1_cfg5_fine_delay[4:0] = 0x3
dut.write(0xF3, 0x3)
...
# clkgrp3_div2_cfg12_divrat_lsb[7:0] = 0x20
dut.write(0xFB, 0x20)
...
# clkgrp3_div2_cfg2_mutesel[7:6] = 0x2
dut.write(0x102, 0x93)
...
dut.write(0x104, 0x71)

# clkgrp4_div1_cfg12_divrat_lsb[7:0] = 0x48
...
dut.write(0x10E, 0x7D)

# clkgrp4_div2_cfg12_divrat_lsb[7:0] = 0x20
...
# clkgrp4_div2_cfg2_mutesel[7:6] = 0x2
dut.write(0x116, 0x93)
...
dut.write(0x118, 0x71)

# clkgrp5_div1_cfg12_divrat_lsb[7:0] = 0x48
...
dut.write(0x122, 0x7D)

# clkgrp5_div2_cfg12_divrat_lsb[7:0] = 0x20
...
# clkgrp5_div2_cfg2_mutesel[7:6] = 0x2
dut.write(0x12A, 0x93)
...
# clkgrp6_div1_cfg12_divrat_lsb[7:0] = 0x48
...
# clkgrp6_div2_cfg12_divrat_lsb[7:0] = 0x20
...
# clkgrp6_div2_cfg2_mutesel[7:6] = 0x2
dut.write(0x13E, 0x91)
...
# clkgrp7_div1_cfg12_divrat_lsb[7:0] = 0x48
...
# clkgrp7_div2_cfg12_divrat_lsb[7:0] = 0x20
...
# clkgrp7_div2_cfg12_mslip_lsb[7:0] = 0x1
dut.write(0x14F, 0x1)
...
# clkgrp7_div2_cfg2_mutesel[7:6] = 0x2
dut.write(0x152, 0x93)
